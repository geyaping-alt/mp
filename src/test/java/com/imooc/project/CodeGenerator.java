...
public class CodeGenerator {
    ...
    public static void main(String[] args) {
        ...
        dsc.setUrl("jdbc:mysql://localhost:3306/project?useSSL=false&serverTimezone=GMT%2B8");
        ...
        if(scanner("是否继承基类").equals("y")){
            ...
            // 写于父类中的公共字段
            strategy.setSuperEntityColumns("create_time","modified_time","create_account_id","modified_account_id","create_time","deleted");
        }
